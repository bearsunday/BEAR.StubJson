...
{
    public function __construct(private string $fakeJsonDir, ?AbstractModule $module = null)
    {
    ...
    {
        $this->bind()->annotatedWith(FakeJsonDir::class)->toInstance($this->fakeJsonDir);
